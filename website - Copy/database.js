...
const { response } = require('./web-app-sql');
...
exports.addComments=(user_id,review_id,comments,response)=>{
    let sqlBook = "INSERT INTO comments (user_id, review_id, comments) " +
    "       VALUES (" + user_id + "," + review_id + ",'" + comments +"')";
